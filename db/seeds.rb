...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  games = Game.create!([
     ...
     {name: "Need for Speed: Most Wanted", quantity: 999, year: 2005, trailer: "DEmRkNnCvLU", loan_period: 5,  platforms: platforms[0,3]},
     {name: "DOTA 2", quantity: 976, year: 20133, trailer: "-cSFPIwMEq4", loan_period: 5,  platforms: platforms[1,1]},
     {name: "Mafia III", quantity: 1, year: 2016, trailer: "TNiHOpHbCzM", loan_period: 10,  platforms: platforms[2,1]},
     {name: "Call of Duty: Modern Warfare", quantity: 2, year: 2019, trailer: "bH1lHCirCGI", loan_period: 5,  platforms: platforms[2, 1]}
  ])